...
Krikamol Muandet1
1
RationalIntelligenceLab,CISPAHelmholtzCenterforInformationSecurity,Saarbr�cken,Germany
2
...
providerscanselectfromasetoflicenses,effectivelyforcingthemtobetontheirmodel�sability
...
time,modelproviderspossessmuchmoreknowledgethanregulatorsaboutmodel�sabilitiesand
...
toprove�Thismodelisunsafe�,theregulatornowjudges,�Isthemodelproviderwillingtobet
theirowncapitalonthemodel�ssafety?�
...
compliantdistributionsformsacredalset (Levi,1980)�aclosed,convexsetofprobabilitymeasures.
...
setviathetesting-by-bettingframework(Gr�nwaldetal.,2024;Ramdas&Wang,2024;Shafer,
2021)byallowingthemodelproviderstobetontheirmodel�sability. Wealsodemonstratehow
...
the basis of data. The model�s performance is measured via a loss function ? : Y � Y ? R
?0
...
responsibleforlearningapredictivemodelfromdata,whereastheregulator�sroleistoensure
...
1974), which departs from frequentist views by interpreting probability as an agent�s betting
dispositions ratherthan observedfrequencies. From arobust Bayesian perspective,a credal set
representstheagent�suncertainty: the�true�or�ideal�data-generatingdistributionisassumed
...
to characterize the agent�sbeliefs via the set of risksthey are willing to accept, known as theset
...
| --- | --- | --- | --- | ------ | ---------- | ---- | ----- |
|     | i   |     |     |        | 1 n        |      | i=1 i |
principal�sdesiredoutcomescanthenbecharacterizedbyasocialchoicefunction.
...
that ??? = sup ?(z) ? R for all ? ? ?, which imposes a �market cap� on the maximum
? z?Z
...
marketoutcomesintermsofmodelproviders�exanteparticipationdecisionsunderimplementable
regulatorymechanisms.
(ImplementableRegulationMechanism)LetP ?(Z)bethemodelprovider�s
| Definition3.4. |     |     |     |     |     | ?   |     |
| -------------- | --- | --- | --- | --- | --- | --- | --- |
typeand?denotetheregulationmechanism. Also,letG(?,P) {0,1}betheprovider�sdecision
?
...
canthencombinegamblestomakeforecasterincursureloss,thusrevealingforecaster�sinternal
...
regulation,revealing regulator�sinternalinconsistency. In Figure1,we showthatif P werenot
0
...
same(seethemiddleofFigure1). Thiswouldexposeaninternalinconsistencyintheregulator�s
position.
...
P0
model provider�s proposed ? belongs to ?ob via Equation 2. Theorem 3.7 also shows that ?ob
|     |     |     |     |     | P0  |     |     |     |     | P0  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| ----- | ---------- | --- | ----------------- | --- | ----- | -------------------- | --- | ----------------- | --- | ------- |
| Model | provider�s |     | optimal response. |     |       |                      |     |                   |     |         |
P0
orem 3.7, it is an infinite set. This creates practical difficulties on the model provider�s side, in
particularforselectingtheoptimallicense? ?ob. Toaddressthisissue,wefirstdescribethe
?
P0
modelprovider�sresponsetoanimplementable?. Weassumethatthemodelproviderselectsa
? ? ? that maximizes their expected utility. Given the evidence distribution Q ? ?(Z) as the
provider�sprivateinformation,theirbestresponse?? isobtainedbysolvingthefollowing
Q
|     |     |     |     |     | supE | [?(Z)]. |     |     |     | (3) |
| --- | --- | --- | --- | --- | ---- | ------- | --- | --- | --- | --- |
Z?Q
...
| --- | --- | --- | --- | ------- | --- | --- | --- | --- | --- | --- | --- |
P Q
identifiesa�rejectionregion�wherethelikelihoodoftheirprivateevidenceQissufficientlyhigh
...
Q)thattheyarewillingtoforgoanypotentialreturninthoseregionseffectivelyacceptinga�loss�
| oftheirfeesC |           | inexchangeforsatisfyingthesafetyconstraints. |            |            |     |     |     |     |     |     |     |
| ------------ | --------- | -------------------------------------------- | ---------- | ---------- | --- | --- | --- | --- | --- | --- | --- |
| 4            | Practical |                                              | Regulation | Mechanisms |     |     |     |     |     |     |     |
Under risk-neutral expected-utility maximization, the best response are �all-or-nothing� gambles
...
logarithmicutilityoverlicenses. ThischoicemirrorsBernoulli�sresolution(Bernoulli,1738)of
...
that assign zero payoff to any event with positive subjective probability�since log0 = ??,
...
P(z)R
AP
The model designer�soptimal response?? introduced in Proposition4.1 is a truncated version of
likelihoodratiobetweendesigner�stypedistributionQandanotherdistributionP? ? P . Here,
0
theoptimal responseis acontinuous functionwith fullsupport onall z ? Z. The interpretation
forP? inP issimilartoReverseInformationProjection(Csisz�r&Matus,2003;Li,1999),thatit
0
isthemostsimilardistributioninP toQintermsofa�truncated�KL-divergencewhichexcludes
0
...
i i i=1
onwhichtheregulatorobservestheevidence{z }n forthemodelprovider�smodel. Themapping
i i=1
...
fromreporteddata�anapproachthatiscomputationallyburdensome. Wethereforerelaxthisto
anindirect mechanisminwhichmodelprovidersoptimiseontheirownbehalf. Weoperationalise
thisrelaxation, underadditionalassumptions, usingthe testing-by-bettingframework(Gr�nwald
...
providerwithtypeQsatisfyingR(Q) = 1,i.e.,E [h(z)] > ?. Themodelprovider�sobjectiveisto
Q
chooseanoptimalbet??fornsamplesinordertomaximisetheirlicense. Sinceourmodelprovider
isriskaverse,theoptimalstrategymaximizestheirlicenseaccordingtoKelly�scriterion(Kelly,
...
i i
i=1
Theproviderattemptstopassa�naive�regulatorwhogiveslicensesbytestingagainstthediscrete
|     |     |     |     |     |     |     |     |     | (cid:110) | (cid:111) |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --------- | --------- | --- | --- |
...
thecredalset.
We use the Waterbirds dataset (Sagawa et al., 2020)�a popular benchmark for learning under
spurious correlations�to evaluate the regulation mechanism. The task is to classify birds as
...
|     |     |     |     |     |     |     | 0   |     |     | 1   |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
Here,theregulatordoesnotmaintainarepresentationof�unfairdistributions". Instead,theyoffer
(cid:81)n
...
worst-casereferenceP?,thecompliantagent�slicensegrowsexponentiallytothecapR = 250,
...
compliantagentisalmostentirelydrivenby�HardExamples"(e.g.,WaterbirdsonLand),ason
�EasyExamples�bothagentsagreewiththeregulator�sbaseline(?D ? RO ? 1).
??
ERM
...
regulatorscanoffermodelprovidersachancetobetontheirmodel�sfairnessbychoosing?. This
...
etal.(2022,2023);Min(2023)adoptaprincipal�agentframework,whereasHossainetal.(2025)
...
Strassen,1973;J�rgensetal.,2025)withpotentialforapplicationsinAIregulations. Closelyrelated
toIPtestingliteratureisliteratureontestingbybetting(Gr�nwaldetal.,2024;Ramdasetal.,2023;
...
etal.,2023),differentialprivacy(Gonz�lezetal.,2025)andmanyotherapplications(Shekhar&
...
Huangetal.,2022;Jobinetal.,2019),policy(Diakopoulos,2016;O�neil,2017),socio-cultural(Awad
...
challengesinoperationalisingpolicymakers�normativegoals. Wereviewthesechallengesfurther
inAppendix17.
7 Conclusion
...
References
Amodei,D.,Olah,C.,Steinhardt,J.,Christiano,P.,Schulman,J.,andMan�,D. Concreteproblems
...
254�264.AuerbachPublications,2022.
...
Themoralmachineexperiment. Nature,563(7729):59�64,2018.
...
accountability,andtransparency,pp.610�623,2021.
Bernoulli,D. Specimentheoriaenovaedemensurasortis. Econometrica,22(1):23�36,1738. URL
http://www.jstor.org/stable/1909829. Originallypublished1738,translated
in1954.Translation: �Expositionofanewtheoryonthemeasurementofrisk�byL.Sommer.
Bertolini,A.andEpiscopo,F. Theexpertgroup�sreportonliabilityforartificialintelligenceand
...
InternationalConferenceonMachineLearning,pp.1006�1014.PMLR,2015.
...
the2024ACMConferenceonFairness,Accountability,andTransparency,pp.2254�2272,2024.
...
NeuralInformationProcessingSystems,36:6070�6091,2023.
Chugg,B.,Lardy,T.,Ramdas,A.,andGr�nwald,P. Onadmissibilityinpost-hochypothesistesting.
...
Csisz�r,I.andMatus,F. Informationprojectionsrevisited. IEEETransactionsonInformationTheory,
49(6):1474�1490,2003.
...
TheoriesandApplications,pp.141�152.PMLR,2023.
DeCooman, G.andQuaeghebeur,E. Exchangeabilityandsets ofdesirablegambles. International
JournalofApproximateReasoning,53(3):363�395,2012.
...
2014.Proceedings10,pp.354�370.Springer,2014.
...
EconometricSociety,pp.587�601,1973.
...
Gonz�lez, T., Dulce-Rubio, M., Ramdas, A., and Ribero, M. Sequentially auditing differential
| privacy. | arXivpreprintarXiv:2509.07055,2025. |     |     |     |     |     |     |     |
| -------- | ----------------------------------- | --- | --- | --- | --- | --- | --- | --- |
Gr�nwald, P., de Heide, R., and Koolen, W. Safe testing. Journal of the Royal Statistical Society
SeriesB:StatisticalMethodology,86(5):1091�1128,2024.
...
IEEE
TransactionsonArtificialIntelligence,4(4):799�819,2022.
Huber,P.J.andStrassen,V. Minimaxtestsandtheneyman-pearsonlemmaforcapacities.
The
AnnalsofStatistics,pp.251�263,1973.
17
...
benchmarkingviathegsd-front. AdvancesinNeuralInformationProcessingSystems,37:98143�
98179,2024.
Jobin, A.,Ienca, M., andVayena, E. Theglobal landscapeof aiethics guidelines. Naturemachine
intelligence,1(9):389�399,2019.
J�rgens, M., Mortier, T., H�llermeier, E., Bengs, V., and Waegeman, W. A calibration test for
evaluatingset-basedepistemicuncertaintyrepresentations. MachineLearning,114(9):202,2025.
Kelly,J.L. Anewinterpretationofinformationrate. thebellsystemtechnicaljournal,35(4):917�926,
1956.
Korinek, A. and Vipra, J. Concentrating intelligence: scaling and market structure in artificial
intelligence. EconomicPolicy,40(121):225�256,2025.
...
auditability. InformationSystemsFrontiers,27(3):1121�1151,2025.
Lohn, A. and Musser, M. How much longer can computing power, drive artificial intelligence
progress?,2022.
Maskin,E. Nashequilibriumandwelfareoptimality. TheReviewofEconomicStudies,66(1):23�38,
1999.
...
Min,D. Screeningforexperiments. GamesandEconomicBehavior,142:73�100,2023.
Myerson,R.B. Incentivecompatibilityandthebargainingproblem. Econometrica: journalofthe
EconometricSociety,pp.61�73,1979.
Myerson,R.B. Optimalauctiondesign. MathematicsofOperationsResearch,6(1):58�73,1981.
...
MathematicalorPhysicalCharacter,231(694-706):289�337,1933.
18

Nisan, N. et al. Introduction to mechanism design (for computer scientists).
|     |     |     |     |     |     | Algorithmic | game |
| --- | --- | --- | --- | --- | --- | ----------- | ---- |
theory,9:209�242,2007.
O�neil, C. Weapons ofmath destruction: How bigdata increasesinequality andthreatensdemocracy.
Crown,2017.
...
SocietyA:Mathematical,PhysicalandEngineeringSciences,369(1956):4913�4931,2011.
...
Ramdas,A.,Gr�nwald,P.,Vovk,V.,andShafer,G. Game-theoreticstatisticsandsafeanytime-valid
| inference. | StatisticalScience,38(4):576�601,2023. |     |     |     |     |     |     |
| ---------- | -------------------------------------- | --- | --- | --- | --- | --- | --- |
...
Advancesin
NeuralInformationProcessingSystems,37:68559�68594,2024.
Roughgarden,T. Algorithmicgametheory. CommunicationsoftheACM,53(7):78�86,2010.
...
| development. | Geopolitics,pp.1�30,2025. |     |     |     |     |     |     |
| ------------ | ------------------------- | --- | --- | --- | --- | --- | --- |
Shafer, G. Testingby betting: Astrategy forstatisticalandscientific communication.
Journal of
theRoyalStatisticalSocietySeriesA:StatisticsinSociety,184(2):407�431,2021.
...
InInternationalconferenceonmachinelearning,pp.5389�5400.PMLR,2024.
Singh, A.,Chau, S.L., andMuandet, K. Truthfulelicitation ofimprecise forecasts. InConference
onUncertaintyinArtificialIntelligence,pp.3898�3919.PMLR,2025.
Solaiman,I. Thegradientofgenerativeairelease: Methodsandconsiderations. InProceedingsof
the2023ACMconferenceonfairness,accountability,andtransparency,pp.111�122,2023.
Tabassi,E. Artificialintelligenceriskmanagementframework(airmf1.0). NIST,2023.
Taddeo,M.andFloridi,L. Howaicanbeaforceforgood. Science,361(6404):751�752,2018.
...
IntelligenceandStatistics,pp.365�372.PMLR,2005.
...
JournaloftheRoyalStatisticalSocietySeriesB:StatisticalMethodology,86(1):1�27,2024.
...
ArtificialIntelligenceandStatistics,pp.3997�4005.PMLR,2024.
...
| --- | ----- | ----- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| reg |       | ??? ? |     |     |     |     |     |     |     |     |     |
provethatP (?)isclosedweneedtoshowthatallA areclosedsets. Let�schooseanarbitrary
|     | reg |     |     |     |     |     | ?   |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
Proof.
P
R }thatis i 0 mplementable. Thismeans that,either? ?obd or? ?obd. Let�s
| ?   | = {? | : Z ? |     |     |     |     |     |     | ?   | ??  |     |
| --- | ---- | ----- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|     |      |       | ?0  |     |     |     |     |     | P0  |     | P0  |
...
? asC(Z)isdenseinL(Z)underL norm. Wenowclampg intog� asfollows:
1 n n
?
0 ifg (z) ? 0
? ? n
...
=? |g� ??| ? |g ??| ?n ? N
n 1 n 1
Since lim |g ? ?| = 0 we can say that {g� } also converges to ?. We now transform
n?? n 1 n n?N
the sequence {g� } into another sequence {? } such that ? ? ?ob. Let us consider a
? ? ?ob where n su n? p N E [? ] := C ?? forso n m n e ?N ? > 0. Wenow n const P r 0 uctour? ? ?ob as
ref P0 P?P P ref n P0
follows
? (z) := (1?? )g� (z)+? ? (z) ?n ? N
n n n n ref
where? ? [0,1]. Ifg� ? ?ob wecanset? = 0otherwisewecanselectasuitable? forevery
n ? N as
n
? = ?n w
n
...
n n
= C
Hence {pi } ? ?ob. Given that {g� } converges to ?. Hence lim ? = 0 and hence
...
| ---- | ----- | --- | ----------- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
Nowlet�sbeginwiththeproofofthemainclaimsinProposition3.8. GivenProposition11.2we
...
|     |     |     |     |     | ob,Q |     |     |     | P?P0 | P   | ob,Q |     |     |     |
| --- | --- | --- | --- | --- | ---- | --- | --- | --- | ---- | --- | ---- | --- | --- | --- |
C < R,thenletusconsideranother?� (z) = min{C?? (z),R}. Firstweverifythat?� ? ?ob.
|     |     |     |     |     |     | Q   |     | ob,Q |     |     |     |     | Q   |     |
| --- | --- | --- | --- | --- | --- | --- | --- | ---- | --- | --- | --- | --- | --- | --- |
|     |     |     |     |     |     |     |     | K    |     |     |     |     |     | P0  |
C
...
|     |     | �ob | 1?ob |     |     |     |     |     |     |     |     |     |     |
| --- | --- | --- | ---- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
strained set ? := = {?� : Z ? [0, R]|sup E [?�(z)] ? 1}. We consider the
|     |     | P0  | C P0 |     |     |     | C   | P?P0 | P   |     |     |     |     |
| --- | --- | --- | ---- | --- | --- | --- | --- | ---- | --- | --- | --- | --- | --- |
...
| --- | --- | -------- | --- | --- | -------- | --- | ---------------- | --- | --- | --- | -------- | --- | --- |
R
L(?�,?,?) := log(?�(z))dQ(z)? ?(P) ?�(z)dP(z)?C ? ?(z)(?�(z)? )dz
C
|     |     | Z   |     |     | P0  |     |     | Z   |     |     | Z   |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
0
respectively. The necessary conditions for ?�? is that ? L(?�,?,�) = 0. Therefore, taking the
?�
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|     |     | 0   |     |     | ?   |     | P   |     |     |     |     |     |     |
. Let�s try to simplyfy the expres sion for 0 ?(z) further, we know from the complementary
| P   |     |     |     |     |     |     | ?�  |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
0
slacknessconditionsthat?(z)(?�?(z)? R) = 0andthat?(z) ? 0forallz ? Z. Letsconsiderthe
C
followingtwocases,
|     | � CaseI: | Q(z) | R.  |     |     |     |     |     |     |     |     |     |     |
| --- | -------- | ---- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| --- | --- | ----- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
?
Since Q(z) R itimpliesthat Q(z) R as?(z) 0. Therefore,?�?(z) R andhence
|     |     | <     |     |     |            |     | <   |     | ?   |     |     | <   |     |
| --- | --- | ----- | --- | --- | ---------- | --- | --- | --- | --- | --- | --- | --- | --- |
|     |     | P (z) | C   |     | P (z)+?(z) |     | C   |     |     |     |     | C   |     |
|     |     | ?     |     |     | ?          |     |     |     |     |     |     |     |     |
?(z) = 0bycomplementaryslackness. Thismeansthat,?�?(z) = Q(z)
P ? (z)
|     | � CaseII: | Q(z) | R.  |     |     |     |     |     |     |     |     |     |     |
| --- | --------- | ---- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
>
...
Hence, ?�?(z) = min{Q(z) , R}. In order to write the exact ?�?(z) in the closed form we discuss
P (z) C
?
how can one characterise P ? P . To this end we consider the dual problem as g(?,?) :=
? 0
max L(?�,?,?). Thenwecanminimisethedualobjectivetofindbest?,i.e.
?
(cid:33)
(cid:90) (cid:90) (cid:18)(cid:90) (cid:90)
ming(?,?) := min log(?�?(z))dQ(z)? ?(P) ?�?(z)dP(z)?1 ? ?(z)(??(z)?R)dz
? ?
Z P0 Z Z
...
P?P0 {z:Q(z)>R} P(z)R
P(z) C
Given we now have the optimal solution ?� ? ? �ob is related to optimal solution ?? ? ?ob as
P0 P0
?ob = C? �ob,wesaythat??(z) = C?�(z).
P0 P0
?? ? argmaxE [log(?)] = argmaxE [log(C �?)] = argmax(logC +E [log(?�)]).
Q Q Q
???ob ??C?�ob ?�??�ob (cid:124)(cid:123)(cid:122)(cid:125)
P0 P0 P0 constant
35
...
| --- | --- | --- | --- | --- | ------ | ----- | --- | --- | --- | --- | --- | --- |
|     |     |     |     |     |        | n n?1 |     |     |     |     |     |     |
filtration(F ) ifM is measurablewith respectto theprevious timestep�s information,F .
|     | n   | n?0 | n   |     |     |     |     |     |     |     |     | n?1 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
|     |     |     |     | [M | F | ] ? M |     |                 |     |     |     |     |      |
|     |     |     |     | P n    | n?1   | n?1 |                 |     |     |     |     |      |
Themartingale representsa �fairgame�between aforecaster andthenature wherethe expected
...
| --- | --- | ----- | --- | ----- | --- | --- | --- | --- | --- | --- |
|     |     | 1     |     | 2     |     |     | 1   | R 2 |     |     |
has a natural total order ?, then the must agree with this total order. For example, let�s
| Z   |     |     |     |     | ?   |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
R
...
? ? ? can be interpreted as the elicitation of the agent�s type (P ? ?(Z)) based on incentive
...
|     |     | 1                                    |     |     |     |         | 0   |
We consider the standardized quadratic error for features under OLS estimator �as the test
X ?
| statistic. ThatisQ |     |       | �                 |     | � ???)whichisa?2 |     | distributedandwhich |
| ------------------ | --- | ----- | ----------------- | --- | ---------------- | --- | ------------------- |
|                    | =   | n Q = | n (? ???)?(XX?)(? |     |                  |     |                     |
|                    | std | ?2    | ?2                |     |                  |     | d                   |
...
|     |     | ? = | (X?X)?1X?y |     | = ?? | +(X?X)?1X??. |     |     |     | (22) |
| --- | --- | --- | ---------- | --- | ---- | ------------ | --- | --- | --- | ---- |
Undertheseassumptions,thecovarianceoftheestimatorisCov(? � ) = ?2(X?X)?1 = ?2? �?1.
n
Theagent�sriskforsomeparameter?,evaluatedusingapositivesemi-definitematrix? � = 1X?X,
n
is
|     |      |     | 1      |         |     | 1        |           |     |     |     |
| --- | ---- | --- | ------ | ------- | --- | -------- | --------- | --- | --- | --- |
...
as general as �intelligence� and have such close human interaction. One key issue is that the
liabilityofAImodel�sriskisfragmentedacrossmodeldesigners,datasuppliers,integrators,and
...
providers also known as �big-tech� in compute and data creates political-economy pressures
